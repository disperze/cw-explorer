...
export const NETWORKS: Network[] = [
  { id: 'cosmoshub-4', name: 'Cosmos Hub', explorer: 'https://www.mintscan.io/cosmos/tx/' },
  { id: 'osmosis-1', name: 'Osmosis', explorer: 'https://www.mintscan.io/osmosis/tx/' },
  { id: 'juno-1', name: 'Juno', explorer: 'https://www.mintscan.io/juno/tx/' },
  { id: 'neutron-1', name: 'Neutron', explorer: 'https://www.mintscan.io/neutron/tx/' },
  { id: 'stargaze-1', name: 'Stargaze', explorer: 'https://www.mintscan.io/stargaze/tx/' },
];
